...
import 'package:colorlive/pages/coming_page/components/tv_component/shimmercell_component/component.dart';
import 'package:colorlive/pages/coming_page/components/tv_component/shimmercell_component/state.dart';
import 'package:colorlive/pages/coming_page/components/tv_component/tvcell_component/component.dart';
...
class _TVlistConnector extends ConnOp<TVListState, List<ItemBean>> {
  ...
  List<ItemBean> get(TVListState state) { 
    ...
    items.add(ItemBean(
        'shimmercell',
        ShimmerCellState( showShimmer: state.tvcoming.page == state.tvcoming.total_results &&state.tvcoming.results.length > 0)));
    return items;
  }
