...
import 'package:colorlive/pages/home_page/components/movie_component/component.dart';
import 'package:colorlive/pages/home_page/components/popular_cpmponent/component.dart';
import 'package:colorlive/pages/home_page/components/searchbar_component/component.dart';
      ...
      : super(
          ...
          dependencies: Dependencies<HomePageState>(
              ...
              slots: <String, Dependent<HomePageState>>{
                ...
                'popularposter': PopularPosterConnector() + PopularPosterComponent()
              }),
